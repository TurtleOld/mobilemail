...
sealed class UpdateCheckUiState {
    ...
    data class UpdateAvailable(val versionName: String, val apkSizeBytes: Long) : UpdateCheckUiState()
...
internal fun UpdateCheckResult.toUiState(): UpdateCheckUiState = when (this) {
    is UpdateCheckResult.UpdateAvailable -> UpdateCheckUiState.UpdateAvailable(versionName, apkSizeBytes)
